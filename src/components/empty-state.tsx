...
// conventions (rounded-[100px], #E8E6E0) but uses a dashed border to read as
...
export function EmptyState({ title, action }: { title: string; action?: ReactNode }) {
  return (
    <motion.div
      ...
      className="rounded-[100px] border border-dashed border-[#E8E6E0] bg-[#EFEFEF] px-6 py-10 text-center"
    >
