  ...
  return (
    <div className="space-y-3">
      <MotionButton
        ...
        className="flex w-full items-center justify-center gap-2 rounded-[100px] border border-[#E8E6E0] bg-white py-3 text-sm font-medium text-[#101010] shadow-brand transition-colors hover:bg-[#EDF3EF] disabled:opacity-50"
      >
      ...
      <MotionButton
        ...
        className="flex w-full items-center justify-center gap-2 rounded-[100px] bg-black py-3 text-sm font-medium text-white shadow-brand transition-colors hover:bg-[#101010] disabled:opacity-50"
      >
