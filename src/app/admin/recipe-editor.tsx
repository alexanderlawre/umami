      ...
      <div className="w-full max-w-2xl rounded-[100px] bg-[#EFEFEF] p-6 shadow-xl">
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-full border border-[#E8E6E0] px-3 py-1 text-xs text-[#6B7370] shadow-brand"
          >
            Close
          </button>
        </div>
        ...
        <div className="mt-5 space-y-5">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  disabled={saving}
                  className="rounded-full border border-[#E8E6E0] px-3 py-2 text-xs text-[#101010] shadow-brand disabled:opacity-50"
                >
                  Change photo
                </button>
              </div>
          ...
          <div className="flex gap-3 border-t border-[#E8E6E0] pt-4">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 rounded-[100px] border border-[#E8E6E0] py-3 text-sm font-medium text-[#101010] shadow-brand"
            >
              Cancel
            </button>
            <button
